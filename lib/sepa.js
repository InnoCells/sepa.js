...
(function (exports) {
  ...
  SepaGroupHeader.prototype = {
    ...
    toXML: function (doc) {
      ...
      var emitter = n(grpHdr, 'InitgPty');
      r(emitter, 'Nm', this.initiatorName);

      if (this.organizationId) {
        var creditorScheme = n(emitter, 'Id', 'OrgId', 'Othr');
        r(creditorScheme, 'Id', this.organizationId);
        r(creditorScheme, 'SchmeNm', 'Cd', 'CORE');
      }
